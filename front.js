...
var loadingImg = document.getElementById('loading_img').innerHTML
...
// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// check input ว่ามีค่าว่างหรือไม่
// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
// คำสั่ง ดึงหน้า html มาแสดงใหม่ แทนที่ div เดิม
// สร้าง function เพื่อดึง content จากหลังบ้าน(คำสั่ง loadPartialHTML_) มาแสดงในหน้า front end

function loadView(options){
  var id = typeof options.id === "undefined" ? "home_view" : options.id ;
